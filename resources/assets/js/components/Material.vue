                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="input-group-append">
                                            <button type="submit" :disabled="buscar == ''" @click="listarMaterial(1,Activo,buscar,criterio)" class="btn green float-right mt-2 btn-sm">
                           ...
                           <div class="col-md-3 vista-C">
                                   <select class="form-control mt-2"  v-model="Activo" @click="listarMaterial(1,Activo,buscar,criterio)" >

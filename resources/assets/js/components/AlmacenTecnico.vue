                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4" v-show="criterio==1">
                                    <div class="md-form input-group mt-0 mb-3">
                                        <input type="text"  id="busSap" class="form-control" placeholder="CODIGO SAP">
                                    </div>
                                </div>
                                <div class="col-md-4" v-show="criterio==2">
                                    <div class="md-form input-group mt-0 mb-3">
                                        <input type="text"  id="busSerie" class="form-control" placeholder="Serie de Producto">
                                    </div>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-sm item">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="almacen in arrayAlmacen" :key="almacen.idalmacen" class="nombres" >
                                        <!-- <td v-text="categoria.idCategoria" ></td> -->
                                        <!-- <td v-text="almacen.ctdetsa_sot"></td> -->
                                        <td v-text="almacen.ctdetsa_traspaso"></td>
                                        <td class="restSap" v-text="almacen.ctdetsa_sap"></td>
                                        <td class="restSerie" v-text="almacen.ctdetsa_serie"></td>
    ...
    export default {
            ...
            actualizarTecnico(){
                ...
                axios.patch('/salida/actualizar',{
                    ...
                    let respuesta = response.data;
                     ...
                     let mensajeUser =response.data.msj;
        ...
        mounted() {
            ...
            $(document).ready(function(){
                // busqueda sap
                $('#busSap').keyup(function(){
                    var nombres = $('.nombres .restSap');
                ...
                // busqueda serie
                $('#busSerie').keyup(function(){
                    var nombres = $('.nombres .restSerie');
                    var buscando = $(this).val();
                    var item='';
                    for( var i = 0; i < nombres.length; i++ ){
                        item = $(nombres[i]).html().toLowerCase();

    ...
    export default {
        ...
        methods:{
           ...
           exportPdf(){ 
                ...
                let userTo = vm.arrayUsuario[0].ctusuar_usuario;
                ...
                let columns = [
                    ...
                    {title: "DESCRIPCIÓN", dataKey: "concaCaDes"},
                        ...
                        {   
                            if (this.buscarArticulo(this.arrayEquiEn[index].Serie)) 
                            {
                                ...
                                this.tasks.push({
                                    ...
                                    // concatenacion
                                   concaCaDes:(this.arrayEquiEn[index].ctcatego_desc)+" | "+this.arrayEquiEn[index].ctproduc_nombre,
